    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_type', models.CharField(choices=[('default', 'Default'), ('local', 'Local'), ('community', 'Community')], default='default')),
                ('comment', models.CharField(blank=True, null=True)),
                ('parent_geo_unit_type', models.CharField(blank=True, choices=[('vtd', 'VTD'), ('bg', 'Block group'), ('block', 'Block')], null=True)),
                ('child_geo_unit_type', models.CharField(blank=True, choices=[('vtd', 'VTD'), ('bg', 'Block group'), ('block', 'Block')], null=True)),
                ('data_source_name', models.CharField(blank=True, null=True)),
                ('statefps', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(), blank=True, null=True, size=None)),
        ...
        migrations.CreateModel(
            name='Overlay',
            fields=[
                ('overlay_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('name', models.CharField()),
                ('description', models.CharField(blank=True, null=True)),
                ('data_type', models.CharField(choices=[('geojson', 'GeoJSON'), ('pmtiles', 'PMTiles')])),
                ('layer_type', models.CharField(choices=[('fill', 'Fill'), ('line', 'Line'), ('text', 'Text')])),
