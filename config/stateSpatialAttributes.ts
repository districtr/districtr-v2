 ...
 * @param {any} spatialPropertiesObject - An object with properties describing various spatial attributes.
 ...
 */
export const stateSpatialAttributes : {[stateName: string] : any} = {
    alabama: {
