...
export default function GuidePage() {
  return (
    <Flex className="w-full mx-auto max-w-screen-lg" direction="column" gapY="4">
      ...
      <LoopVideoPlayer videoUrl={`${process.env.NEXT_PUBLIC_S3_BUCKET_URL}/videos/paint_1.webm`} />
      <Text>
      ...
      <LoopVideoPlayer videoUrl={`${process.env.NEXT_PUBLIC_S3_BUCKET_URL}/videos/paint_2.webm`} />
      <Text>
      ...
      <LoopVideoPlayer videoUrl={`${process.env.NEXT_PUBLIC_S3_BUCKET_URL}/videos/erase.webm`} />
      <Text>
      ...
      <LoopVideoPlayer videoUrl={`${process.env.NEXT_PUBLIC_S3_BUCKET_URL}/videos/shatter.webm`} />
      <Text>
