...
export const PopulationPanelOptions: React.FC<{
  ...
  useEffect(() => {
    if (
      isCommunityMode &&
      (!chartOptions.popBarScaleToCurrent || chartOptions.popShowTopBottomDeviation)
    ) {
      setChartOptions({
        popBarScaleToCurrent: true,
        popShowTopBottomDeviation: false,
      });
    }
  }, [
    chartOptions.popBarScaleToCurrent,
    chartOptions.popShowTopBottomDeviation,
    isCommunityMode,
    setChartOptions,
  ]);
          ...
          >
            ...
            {!isCommunityMode && (
              <CheckboxGroup.Item
                ...
                onClick={() =>
                  setChartOptions({
                    popShowTopBottomDeviation: !chartOptions.popShowTopBottomDeviation,
                  })
                }
                className="cursor-pointer"
              >
                        ...
                        onChange={e => {
                          if (e.target.value === '') {
                            ...
                            setChartOptions({
                              ...
                              popTargetPopDeviationPct:
                                Math.round((value / idealPopulation) * 10000) / 100,
                            });
                          }
                        }}
                      ></TextField.Root>
