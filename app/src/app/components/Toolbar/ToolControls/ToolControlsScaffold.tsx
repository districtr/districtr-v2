...
// the left/right columns stop stacking. Picked by eye, not measurement — the
// human will tune this visually once the layout is in front of them.
const TWO_COLUMN_BREAKPOINT = 380;
