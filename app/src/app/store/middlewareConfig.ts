...
export const temporalConfig: ZundoOptions<any, MapStore> =  {
  ...
  partialize: state => {
    const {zoneAssignments, mapRenderingState, appLoadingState, shatterIds, shatterMappings, colorScheme} = state;
    return {zoneAssignments, mapRenderingState, appLoadingState, shatterIds, shatterMappings, colorScheme} as Partial<MapStore>;
  },
}
