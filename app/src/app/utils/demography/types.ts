import {
  CleanedTOTPOPZoneSummaryStats,
  CleanedVAPZoneSummaryStats,
  TOTPOPTotPopSummaryStats,
  VAPVapPopSummaryStats,
} from '../api/summaryStats';

export type DemographyRow = {path: string; sourceLayer: string} & TOTPOPTotPopSummaryStats &
  VAPVapPopSummaryStats;
export type AllPropertyKeys =
  | keyof TOTPOPTotPopSummaryStats
  | keyof VAPVapPopSummaryStats
