...
class DemographyCache {
  ...
  update(
    ...
    const popsOk = this.updatePopulations(zoneAssignments, coalitionGroups);
    if (!popsOk) return;
   ...
   */
  updatePopulations(zoneAssignments?: ZoneAssignmentsMap, coalitionGroups: CoalitionGroupKey[] = []) {
