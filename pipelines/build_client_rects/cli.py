...
@click.option("--min-coverage", "-c", help="Minimum coverage of the geometry", default=0.85)
@click.option("--max-coverage-overlap", "-m", help="Maximum coverage overlap of the geometry", default=1.15)
@click.option("--min-cell-coverage", "-C", help="Minimum cell coverage of the geometry", default=0.75)
