...
def upgrade() -> None:
    # Add columns
    op.add_column('districtrmap', sa.Column('parent_tiles_s3_path', sa.String(), nullable=True))
    op.add_column('districtrmap', sa.Column('child_tiles_s3_path', sa.String(), nullable=True))
