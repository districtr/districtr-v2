...
summary_udfs = [
    {"name": "get_summary_stats_p1", "filepath": "summary_stats_p1.sql"},
    {"name": "get_summary_p1_totals", "filepath": "summary_stats_p1_totals.sql"},
    {"name": "get_summary_stats_p4", "filepath": "summary_stats_p4.sql"},
    {"name": "get_summary_p4_totals", "filepath": "summary_stats_p4_totals.sql"},
    {"name": "get_total_population", "filepath": "total_pop_udf_rev2.sql"},
    {
