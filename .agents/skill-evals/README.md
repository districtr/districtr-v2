...
| `blank-map-debug` | F9 name-triple warning (debug side) | The routing-mismatch argument (rendering-framed session never loads map-data knowledge) is untested; the failure is silent by design. |
