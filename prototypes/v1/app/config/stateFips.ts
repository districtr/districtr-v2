/**
 * @interface FIPSCountyHash
 * @param {number} key - FIPS code.
 ...
 * @param {string | number} value - FIPS code.
 ...
 */
export const stateNameToFips : { [name : string] : string | number} = {
    alabama: "01",
    alaska: "02",
    arizona: "04",
    arkansas: "05",
...
/**
 * Denotes a mapping of state to an object with FIPS codes as keys and 
 * the corresponding county as values.
 * @type {Object}
 * @param {string} name - State name.
 * @param {FIPSCountyHash} value - A mapping of FIPS code to county name.
 * @see Original Districtr reference : {@link https://github.com/uchicago-dsi/districtr-legacy/blob/e88ef1a8be7e40d3a7a00360dc95fd4239dd6c43/src/utils.js}
 */
export const fipsToCounty : { [ name : string ] : FIPSCountyHash }= {
    ohio:
    {
        1: "Adams",
        3: "Allen",
